    ...
    <div className="max-w-lg mx-auto relative">
        ...
        <div className="relative">
          ...
          <div className="absolute left-4 bottom-4 text-white">
            <h2 className="text-2xl font-bold drop-shadow">
              Чөлөөт бөхийн дугуйлан
            </h2>
            <p className="text-sm text-white/90">
              Хүүхэд, өсвөр үеийнхэнд зориулсан мэргэжлийн сургалт
            </p>
          </div>
          ...
          <div className="absolute top-4 right-4">
            <span className="inline-flex items-center px-3 py-1 rounded-full bg-white text-blue-900 text-sm font-semibold">
              150,000₮/сар
            </span>
          </div>
        </div>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div
            className="relative bg-white rounded-2xl p-6 w-11/12 max-w-sm mx-auto shadow-2xl"
            role="dialog"
            aria-modal="true"
          >
            <button
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-sm text-gray-600">
                Чөлөөт бөхийн дасгалжуулагч · 10 жилийн туршлага
              </p>
            </div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-gray-700">
              ...
              <li className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-gray-500" aria-hidden />{" "}
                <span>9911-2233</span>
              </li>
              <li className="flex items-center gap-2">
